...
const LogInModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 font-sans">
      ...
      <div className="relative z-10 w-full max-w-96 bg-white rounded-lg shadow-lg">
        ...
        <div className="p-6">
          ...
          <div className="flex flex-col space-y-4 mb-6">
            <button className="flex items-center justify-center w-full px-4 py-2 font-bold text-black bg-white border-2 border-gray-200 rounded-lg">
